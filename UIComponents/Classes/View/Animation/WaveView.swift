...
public class WaveView: UIView {
    ...
    public var _h: Float = 10
    public var speed: Float = 0.2
    public var waveHeight: Float = 1
    ...
    @objc func doAni() {
        ...
        _layer?.path = pathRef
        _layer?.fillColor = self.backgroundColor?.cgColor ?? UIColor.white.cgColor
        ...
        _layer2?.fillColor = self.backgroundColor?.cgColor ?? UIColor.white.cgColor
